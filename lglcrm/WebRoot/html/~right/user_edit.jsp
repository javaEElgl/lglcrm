...
<body>
	...
	<form action="user_update" method="post" id="form1">
		<table class="query_form_table">
			<tr>
				<th>用户名</th>
				<td><input type="text"
					value="<s:property value='#request.edituser.username' />"
					name="u.username" onblur="ck_name('c1','info1')" id="c1" /><span
					id="info1" class="red_star">*</span></td>
			</tr>
			<tr>
				<th>密码</th>
				<td><input type="password"
					value="<s:property value='#request.edituser.password' />"
					name="u.password" onblur="ck_pwd('c2','info2')" id="c2" /><span
					id="info2" class="red_star">*</span></td>
			</tr>
			<tr>
				<th>所属角色</th>
				<td><select name="u.role.roleId">
						<s:iterator var="v" value="#session.rolelist">
							<option value="<s:property value='#v.roleId'/>"><s:property
