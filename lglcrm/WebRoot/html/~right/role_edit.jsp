...
<body>
	<input type="hidden" id="roleright" value="<s:property value="#request.right" />">
	<div class="page_title">角色授权管理&gt;修改角色权限</div>
	<div class="button_bar">
		<button class="common_button" onclick="back();">返回</button>
		<button class="common_button" onclick="check();">保存</button>
	</div>
	<form action="role_update" method="post" id="form1">
		<table class="query_form_table">
			<tr>
				<th>编号</th>
				<td><input type="text" name="r.roleId"
					value="<s:property value="#request.editrole.roleId" />"
					readonly="readonly" /></td>
				<th>角色名</th>
				<td><input type="text" name="r.roleName"
					value="<s:property value="#request.editrole.roleName" />"
					onblur="ck_null('c1','info1')" id="c1" /><font id="info1"
					color="red"></font></td>
			</tr>
			<tr>
				<th>授予权限</th>
				<td colspan="3"><br /> <input type="checkbox"
					onclick="sel('rightCode')">[全部选择/取消全部 ]<br /> <br /> <input
