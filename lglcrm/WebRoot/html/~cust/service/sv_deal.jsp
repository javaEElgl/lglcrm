...
<form action="servicer_findHQL?flag=3" method="post" id="form1">
	...
	<s:if test="#v.status == 2">
		<tr>
			...
			<td class="list_data_op">
				<img onclick="to('servicer_edit?flag=3&sv.ID=<s:property value='#v.ID'/>');" title="处理" src="images/bt_deal.gif" class="op_button" />
			</td>
		</tr>
	</s:if>
	<s:else>
...
<form action="servicer_find?flag=3" method="post" >
	<table class="data_list_table">	
			...
			<tr>
				<th colspan="6" class="pager">
					<div class="pager">
						...
						<a href="servicer_find?flag=3&pager.pageIndex=1">第一页</a>
						<a href="servicer_find?flag=3&pager.pageIndex=<s:property value='%{pageIndex-1}'/>">上一页</a>
						<a href="servicer_find?flag=3&pager.pageIndex=<s:property value='%{pageIndex+1}'/>">下一页</a>
						<a href="servicer_find?flag=3&pager.pageIndex=<s:property value='pages'/>">最后一页</a>
